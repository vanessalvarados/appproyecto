...
**Movie Manager** shows the latest articulos currently playing in theaters and the upcoming articulos. The app displays images and basic information about these articulos to the user.
...
* [x] User can **scroll through current articulos and upcoming articulos**
* [x] Layout is optimized with the [ViewHolder](http://guides.codepath.com/android/Using-an-ArrayAdapter-with-ListView#improving-performance-with-the-viewholder-pattern) pattern.
* [x] For each articulo displayed, user can see the following details:
...
* [x] Allow user to view details of the articulo including ratings and popularity within a separate activity.
