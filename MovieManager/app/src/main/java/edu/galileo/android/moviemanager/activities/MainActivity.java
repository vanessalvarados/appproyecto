...
import edu.galileo.android.moviemanager.fragments.factura_fragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_now_playing) {
            ...
            this.setTitle("Solo Ofertas");
            showFragment(fragment);
        } else if (id == R.id.nav_carrito) {
        fragment = carrito_fragment.class;
        this.setTitle("Mi carrito");
        showFragment(fragment);
        }else if (id == R.id.nav_factura) {
            if(!MovieDetailActivity.getListaCarrito().isEmpty()){
                fragment = factura_fragment.class;
                this.setTitle("Mi Factura");
                showFragment(fragment);
            }else{
                Toast.makeText(this, "No exiten articulos agregados", Toast.LENGTH_SHORT).show();
